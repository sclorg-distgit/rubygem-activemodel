...
BuildRequires: %{?scl_prefix}rubygem(bcrypt-ruby) => 3.1.2
BuildRequires: %{?scl_prefix}rubygem(builder) => 3.0.0
BuildRequires: %{?scl_prefix}rubygem(builder) < 3.2
BuildRequires: %{?scl_prefix_ruby}rubygem(minitest)
BuildRequires: %{?scl_prefix}rubygem(mocha)
#BuildRequires: %{?scl_prefix}rubygem(i18n)
BuildArch: noarch
...
# Needs investigation
# Fails in brew although the same tests passed fine in Fedora koji and locally
rm ./test/cases/serializers/xml_serialization_test.rb
